 ...
 */
public interface CenterComponentsOnJPanel {

    String BACKGROUND_IMAGE_PATH = "./../../resources/Other/trees.jpg";
    ImageIcon BACKGROUND_IMAGE_ICON = ImageCache.getImageIcon(BACKGROUND_IMAGE_PATH);
    Image BACKGROUND_IMAGE = BACKGROUND_IMAGE_ICON.getImage();
